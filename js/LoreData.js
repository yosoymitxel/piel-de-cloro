export const LoreData = {
    ...
    intermediate: {
        title: 'Interludio',
        variants: [
            { kind: 'radio', text: '“Realmente no son personas, purgarlos debería ser...”. La señal se corta. Luego silencio.' },
            { kind: 'oido', text: 'Se escuchan gritos y ruidos de personas afuera. Puede ser peligroso.' },
            ...
            { kind: 'radio', text: 'Se rumorea que se alimentan de humedad, moho y agua estancada, pero no se descarta que también de carne podrida.' },
            { kind: 'oido', text: 'Se escuchan ruidos a través de las tuberías, quizá hay alguien ahí.' },
            ...
            { kind: 'registro', text: 'Nota olvidada: “No sé cómo mantener la cordura sabiendo que mucha gente está muriendo ahí fuera”.' },
